...
<head>
	...
	<title>EDUSOFT STUDENT CHAT SYSTEM</title>
  ...
  <script src="<?php echo base_url();?>js/chatjs.js"></script>
...
function chatHeartbeat(){
  ...
  jQuery.ajax({
   url: "<?php echo base_url();?>views/chat/chat.php?action=chatheartbeat",
    cache: false,
    dataType: "json",
...
function closeChatBox(chatboxtitle) {
  ...
  jQuery.post("<?php echo base_url();?>/views/chat/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){ 
  });
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
  ...
  if(event.keyCode == 13 && event.shiftKey == 0)  {
    ...
    if (message != '') {
      jQuery.post("<?php echo base_url();?>/views/chat/chat.php?action=sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
  jQuery.ajax({
    url: "<?php echo base_url();?>/views/chat/chat.php?action=startchatsession",
    cache: false,
    dataType: "json",
    success: function(data) {
