...
<center><h2>All fees details</h2></center>
<?php


echo "<table class='result_table' style='width:100%'>";
echo '<tr><h3><th> Course Name</th><th>Prices</th><th>Level</th></h3><tr/>';

 foreach ($result  as $v) 
echo '<tr>' . '<td>' . $v->course_name  . " " . '</td>' . '<td class="j_date">' . " " . $v->tution_fee . '</td>' . '<td class="j_date">' . " " . $v->level . '</td>' . '<tr/>';
