...
<form class="form-horizontal form-label-left" novalidate method= "post"  action= "<?php echo base_url();?>Edusoft_ctrl/validate_cred" >
        ...
        <div class="footer-grid">
          <h3>Chat System</h3>
          <form class="form-horizontal form-label-left" novalidate method= "post"  action= "<?php echo base_url();?>Edusoft_ctrl/validate_cred" >
          <input id="send" type="submit" value= "Login to chat" name="submit" class="btn btn-success" />
          </form>
         ...
         <div class="footer-grid">
          ...
          <ul>
            ...
            <li><a href="<?php echo base_url();?>select/fee">Datagrid</a></li>
          </ul>
        </div>
        <div class="footer-grid footer-lastgrid">
          <h3>CONTACT US</h3>
          <p>Feel free to reach us via the below details</p>
          <div class="footer-grid-address">
            <p>Tel: 08067824358</p>
            
            <p>Email:<a class="email-link" href="#">info@herosoftware.com</a></p>
          </div>
        </div>
        <div class="clear"> </div>
      </div>
      <div class="copy-right">
       <p>Design by <a href="http://herosoftware.com/">HERO Software</a></p>
        </div>
    </div>
  </div>
</body>
