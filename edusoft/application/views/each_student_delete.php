...
<head>
  ...
  <ol>     <!--====== Displaying Fetched Details from Database ========-->
<?php foreach ($single_student as $students): ?>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    ...
                    <img src="<?php echo base_url();?>uploads/<?php echo $students->username;?>.jpg
...
<p>FIRSTNAME :<?php echo $students->firstname; ?></p>
<p>LASTNAME : <?php echo $students->lastname; ?></p>
...
<!--====== Delete Button ========-->
                        ...
                        <script type="text/javascript">
                         var url="<?php echo base_url() . "index.php/delete_ctrl/delete_student_id/" . $students->id; ?>";

                                  function confirmGetMessage() {
                                    //display a confirmation box asking the visitor if they want to get a message
                                    var theAnswer = confirm("Are you sure yu want to delete?");
                                   ...
                                   //otherwise display another message
                                    ...
                                    //window.location = url+"delete";
                                      alert("Be careful of Pressing the delete Button.  ");
                                    }
                                  }
                          </script>
                    ...
                    <form>
                        <input type="button" onclick="confirmGetMessage()" value="Delete <?php echo $students->firstname; ?>" />
                    </form>
