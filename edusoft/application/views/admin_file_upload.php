  ...
  <ol>    
      ...
      <div class="right_col" role="main">
        ...
        <h4 class="heading"> 
               ...
               <!-- here beging the file upload in admin backend -->
...
<h2>  step 1 completed. <em><strong>Proceed to step 2 by uploading student's Passport</strong></em></h2> 
...
<br /> 
              ...
              <?php echo form_open_multipart('Admin_fUploaded');?>
              ...
              <!-- here beging the file upload in admin backend -->
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">search by department</a>
                        </li>
                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                          <p> <?php foreach ($single_student as $students): ?>  
